  ...
  <div>
    <div className="px-40 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        ...
        <p className="text-[#0d151b] text-base font-normal leading-normal pb-3 pt-1 px-4">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
          <div className="flex flex-1 gap-3 rounded-lg border border-[#cfdce7] bg-slate-50 p-4 flex-col">
            <div
          ...
          <div className="flex items-stretch p-4 gap-8">
            <div className="flex h-full flex-1 flex-col gap-4 text-center rounded-lg min-w-32 pt-4">
              <div
                ...
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCiDWwCRJZsoAyoSxOvpHKfjKhIKVCQdYI9E6SuVUtv5SpZiFwP8DfsDmDZSxbAT6CzDladRTBaRuiL8CN9wgnn1vEfrt7YRdhkF5L6K1oau0nNvhMtd10J8lqMvCH6OUmstkN3_SMNWm72XFMsMXvhxyN7jdiMPnugcQrWJPQ63KTLRCOPElrgfgDpNAKERfaQFTVbSXjlwI6S8eC9KJcvpNexr00-mOzpCBZJ2Aii__YesdX5WT-_OOlOcHoXlq4peGd9wZc5slY")' }}
              ></div>
              <div>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 text-center rounded-lg min-w-32 pt-4">
              <div
                className="bg-center bg-no-repeat aspect-square bg-cover rounded-full flex flex-col self-center w-full"
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAVOHMxx03sul144zC40O9KQNeFsjSW1Drz0XFqpHevyv1CVOIlqzwcnbRxkJBTUpYkzUAPrH1pWqf62Ql4aJpmt_D9kmP_elHb2yFXNDouwX-ecz4rsM2IYeF0ZI4EnK6DYDLoRbHgIHAU57Xk-OxtIDUCm3Ly-0-BAcpEisJkTxi1_P4sG7fWmhYPkzTKZaxqnRc3S2ZmF4mi1MDkjDemjghq1cJ4UG6QhSmOZoWhqhxY-aPsnMm0UGtQKfGTgWlu2fciwAsHqTU")' }}
              ></div>
              <div>
                <p className="text-[#0d151b] text-base font-medium leading-normal">
                  David Lee
            ...
            <div className="flex h-full flex-1 flex-col gap-4 text-center rounded-lg min-w-32 pt-4">
              <div
                className="bg-center bg-no-repeat aspect-square bg-cover rounded-full flex flex-col self-center w-full"
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBWdfqSgm9_3yl_DmjunaDwx8YnLor9yeL6jByfXxWcqNUnAGUHK_GSUfRnaocg2iPGf3SLwq3XSTeERaKHPfoi237mC5iurdfs5e0Y0zhL3wgGSsvxbsNJxn4XhZCxlTw6ueBlgZ01HidD3IPZRkFBJnFHV6aSoTcsLs2ogVQQPe4Mdyd0zchmx1o0BF4aojbC_zAquM7h1fG9CWcLSeRzPzxCnAR9EWQqZDSm8quIdFrC_HvJ2gjRb3ZMQLQc-CpQ5wgsDs0Te0o")' }}
              ></div>
              <div>
                <p className="text-[#0d151b] text-base font-medium leading-normal">
                  Emily Rodriguez
