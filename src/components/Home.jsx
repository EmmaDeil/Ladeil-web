  ...
  return (
    <div className="page home">
      ...
      <div class="flex justify-center p-5">
          <div class="layout-content-container flex flex-col max-w-[auto] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <p class="text-[#111518] tracking-light text-[32px] font-bold leading-tight min-w-72">Choose the plan that's right for you</p>
            </div>
            <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-5 px-4 py-3 @3xl:grid-cols-4">
              <div className="flex flex-1 flex-col gap-4 rounded-xl border border-solid border-[#d5dce2] bg-gray-50 p-6 plan-float" style={{width:'30rem'}}>
                <div class="flex flex-col gap-1" >  
                  <h1 class="text-[#111518] text-base font-bold leading-tight">Basic</h1>
                  <p class="flex items-baseline gap-1 text-[#111518]">
                    <span class="text-[#111518] text-4xl font-black leading-tight tracking-[-0.033em]">$19</span>
                    <span class="text-[#111518] text-base font-bold leading-tight">/month</span>
                  </p>
                </div>
                <button
                  class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#eaedf1] text-[#111518] text-sm font-bold leading-normal tracking-[0.015em]"
                >
                  <span class="truncate">Choose Basic</span>
                </button>
                <div class="flex flex-col gap-2">
                  <div class="text-[13px] font-normal leading-normal flex gap-3 text-[#111518]">
                    <div class="text-[#111518]" data-icon="Check" data-size="20px" data-weight="regular">
              ...
              <div className="flex flex-1 flex-col gap-4 rounded-xl border border-solid border-[#d5dce2] bg-gray-50 p-6 plan-float plan-float-delay-1" style={{width:'30rem'}}>
                <div class="flex flex-col gap-1">
                  <h1 class="text-[#111518] text-base font-bold leading-tight">Standard</h1>
                  <p class="flex items-baseline gap-1 text-[#111518]">
                    <span class="text-[#111518] text-4xl font-black leading-tight tracking-[-0.033em]">$49</span>
                    <span class="text-[#111518] text-base font-bold leading-tight">/month</span>
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-1 flex-col gap-4 rounded-xl border border-solid border-[#d5dce2] bg-gray-50 p-6 plan-float plan-float-delay-2" style={{width:'30rem'}}>
                <div class="flex flex-col gap-1">
                  <h1 class="text-[#111518] text-base font-bold leading-tight">Premium</h1>
                  <p class="flex items-baseline gap-1 text-[#111518]">
                    <span class="text-[#111518] text-4xl font-black leading-tight tracking-[-0.033em]">$99</span>
                    <span class="text-[#111518] text-base font-bold leading-tight">/month</span>
                  </p>
                </div>
                <button
